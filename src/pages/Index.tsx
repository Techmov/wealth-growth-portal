                ...
                <>
                  ...
                  <h1 className="text-4xl sm:text-5xl md:text-6xl font-bold leading-tight mb-6 slide-up">
                    ...
                    <span className="relative inline-block">
                      Wealth <span className="text-yellow-300">Journey</span>
                      <span className="absolute bottom-0 left-0 w-full h-1 bg-yellow-300"></span>
                    </span>
                  </h1>
                  
                  <p className="text-xl md:text-2xl text-white/80 mb-10 max-w-2xl mx-auto">
                    Return to your dashboard to view your current investments and manage your portfolio.
                  </p>
          ...
          <section className="py-16 bg-white">
            <div className="container px-4 mx-auto">
              ...
              <div className="mt-10 text-center">
                <Link to="/dashboard">
                  <Button size="lg" className="bg-wealth-primary hover:bg-wealth-primary/90">
